 ...
 * @icon fa fa-circle-o
 */
class Tada extends Backend
{

    /**
     * Tada模型对象
     * @var \app\admin\model\game\Tada
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\game\Tada;
    ...
    public function patchadd($ids = null)
    {
        ...
        $g_ids = Games::where('cate_id', $params['cate_id'])->where('table_name', 'game_tada')->column('g_id');
