 ...
 * @icon fa fa-circle-o
 */
class Raspa extends Backend
{

    /**
     * Raspa模型对象
     * @var \app\admin\model\game\Raspa
     */
    ...
    public function patchadd($ids = null)
    {
        ...
        $g_ids = Games::where('cate_id', $params['cate_id'])->where('table_name', 'game_raspa')->column('g_id');
