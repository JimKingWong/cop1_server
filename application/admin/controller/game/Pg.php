 ...
 * @icon fa fa-circle-o
 */
class Pg extends Backend
{

    /**
     * Pg模型对象
     * @var \app\admin\model\game\Pg
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\game\Pg;
    ...
    public function patchadd($ids = null)
    {
        ...
        $g_ids = Games::where('cate_id', $params['cate_id'])->where('table_name', 'game_pg')->column('g_id');
