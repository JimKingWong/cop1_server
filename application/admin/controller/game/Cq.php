 ...
 * @icon fa fa-circle-o
 */
class Cq extends Backend
{

    /**
     * Cq模型对象
     * @var \app\admin\model\game\Cq
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\game\Cq;
    ...
    public function patchadd($ids = null)
    {
        ...
        $g_ids = Games::where('cate_id', $params['cate_id'])->where('table_name', 'game_cq')->column('g_id');
