 ...
 * @icon fa fa-circle-o
 */
class Pp extends Backend
{

    /**
     * Pp模型对象
     * @var \app\admin\model\game\Pp
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\game\Pp;
    ...
    public function patchadd($ids = null)
    {
        ...
        $g_ids = Games::where('cate_id', $params['cate_id'])->where('table_name', 'game_pp')->column('g_id');
