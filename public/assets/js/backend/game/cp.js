define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/cp/index' + location.search,
                    add_url: 'game/cp/add',
                    edit_url: 'game/cp/edit',
                    del_url: 'game/cp/del',
                    multi_url: 'game/cp/multi',
                    import_url: 'game/cp/import',
                    table: 'game_cp',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'game_type', title: __('Game_type'), searchList: {"0":__('未分类'),"1":__('老虎机'),"2":__('街机')}, formatter: Table.api.formatter.flag},
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/cp/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/cp/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
