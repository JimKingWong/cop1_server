define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/pp/index' + location.search,
                    add_url: 'game/pp/add',
                    edit_url: 'game/pp/edit',
                    del_url: 'game/pp/del',
                    multi_url: 'game/pp/multi',
                    import_url: 'game/pp/import',
                    table: 'game_pp',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'game_type', title: __('Game_type'), searchList: {"RNG":__('Game_type RNG'),"LC":__('Game_type LC'),"VSB":__('Game_type VSB')}, formatter: Table.api.formatter.flag},
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/pp/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/pp/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
