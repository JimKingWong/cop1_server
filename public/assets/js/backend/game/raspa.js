define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/raspa/index' + location.search,
                    add_url: 'game/raspa/add',
                    edit_url: 'game/raspa/edit',
                    del_url: 'game/raspa/del',
                    multi_url: 'game/raspa/multi',
                    import_url: 'game/raspa/import',
                    table: 'game_raspa',
                }
            });
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/raspa/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/raspa/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
