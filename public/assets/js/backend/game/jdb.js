define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/jdb/index' + location.search,
                    add_url: 'game/jdb/add',
                    edit_url: 'game/jdb/edit',
                    del_url: 'game/jdb/del',
                    multi_url: 'game/jdb/multi',
                    import_url: 'game/jdb/import',
                    table: 'game_jdb',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'game_type', title: __('Game_type'), searchList: {"0":__('Game_type 0'),"7":__('Game_type 7'),"9":__('Game_type 9'),"12":__('Game_type 12'),"18":__('Game_type 18'),"22":__('Game_type 22')}, formatter: Table.api.formatter.flag},
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/jdb/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/jdb/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
