define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/tada/index' + location.search,
                    add_url: 'game/tada/add',
                    edit_url: 'game/tada/edit',
                    del_url: 'game/tada/del',
                    multi_url: 'game/tada/multi',
                    import_url: 'game/tada/import',
                    table: 'game_tada',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'game_type', title: __('Game_type'), searchList: {"0":__('Game_type 0'),"1":__('Game_type 1'),"2":__('Game_type 2'),"3":__('Game_type 3'),"5":__('Game_type 5'),"8":__('Game_type 8')}, formatter: Table.api.formatter.flag},
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/tada/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/tada/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
