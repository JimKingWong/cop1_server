define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/cq/index' + location.search,
                    add_url: 'game/cq/add',
                    edit_url: 'game/cq/edit',
                    del_url: 'game/cq/del',
                    multi_url: 'game/cq/multi',
                    import_url: 'game/cq/import',
                    table: 'game_cq',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'platform', title: __('厂商'), searchList: {"1":__('CQ9')}, formatter: Table.api.formatter.normal},
                        ...
                        {field: 'thumb', title: __('Thumb'), operate: 'LIKE', table: table, class: 'autocontent'},
                        {field: 'type', title: __('Type'), searchList: {"0":__('Type 0'),"1":__('Type 1'),"2":__('Type 2'),"3":__('Type 3')}, formatter: Table.api.formatter.normal},
                        {field: 'game_type', title: __('Game_type'), searchList: {"0":__('未分类'),"1":__('SLOT'),"2":__('ARCADE')}, formatter: Table.api.formatter.normal},
            ...
            $(document).on("click", ".btn-patchadd", function () {
                ...
                // console.log(ids);
                Backend.api.open('game/cq/patchadd?ids=' + ids.join(","), '归类游戏', {area: ['40%', '60%']});
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/cq/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
