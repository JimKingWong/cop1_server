define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/omg/index' + location.search,
                    add_url: 'game/omg/add',
                    edit_url: 'game/omg/edit',
                    del_url: 'game/omg/del',
                    multi_url: 'game/omg/multi',
                    import_url: 'game/omg/import',
                    table: 'game_omg',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'platform', title: __('Platform'), searchList: {"1":__('Platform 1'),"2":__('Platform 2'),"3":__('Platform 3'),"4":__('Platform 4'),"5":__('Platform 5'),"6":__('Platform 6'),"7":__('Platform 7'),"8":__('Platform 8'),"23":__('Platform 23'),"24":__('Platform 24'), "25": __("Platform 25")}, formatter: Table.api.formatter.normal},
                        {field: 'game_id', title: __('Game_id'), operate: 'LIKE'},
                        {field: 'real_game_id', title: __('Real_game_id'), operate: 'LIKE'},
                        ...
                        {field: 'game_type', title: __('Game_type'), searchList: {"1":__('Game_type 1'),"2":__('Game_type 2'),"3":__('Game_type 3'),"4":__('Game_type 4')}, formatter: Table.api.formatter.normal},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/omg/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
